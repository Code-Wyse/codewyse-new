...
function ProductStorySection() {
  return (
    ...
    <div className="py-24 max-md:px-8 max-w-3xl mx-auto">
        ...
        <Image
        alt="image"
        src="/images/sass/maker-of-the-year.png"
        width={200}
        height={200}
        ...
        />
            {/* <img
                ...
                srcset="/_next/static/media/maker-of-the-year-2023.285fe739.png 1x, /_next/static/media/maker-of-the-year-2023.285fe739.png 2x"
                src="/_next/static/media/maker-of-the-year-2023.285fe739.png"> */}
            <p className="mb-4 text-base-content md:text-lg font-medium">Hey, it's Marc 👋</p>
            <p className="mb-5">In 2018, I believed I was Mark Zuckerberg, built a startup for 1 year, and got 0 users...
            </p>
            <p className="mb-5">A few years after my burnout, I restarted the journey differently: I shipped like a
                madman—<a className="link text-base-content font-medium hover:link-accent whitespace-nowrap" target="_blank"
                    href="#">16 startups in 2 years.</a>Now I'm happy and
                earn $45,000 a month.</p>
            <p className="mb-5">I realized I was doing the same thing over and over: set up DNS records, listen to Stripe
                webhooks, design pricing section... So I built ShipFast for 3 reasons:</p>
            <ul className="list-inside list-decimal space-y-1.5 ml-5 mb-5">
                <li><span className="text-base-content font-medium">Save time</span> and focus on what matters:
                    building a business</li>
                <li><span className="text-base-content font-medium">Avoid headaches</span> like emails ending in
                    spam or handling Stripe subscriptions</li>
                <li><span className="text-base-content font-medium">Get profitable fast</span>—the more you ship, the more
                    you learn, the more you earn</li>
            </ul>
            <p><a className="link whitespace-nowrap text-base-content hover:link-accent font-medium group" target="_blank"
                    href="#">135,000+ people</a> trust me on Twitter, Product
                Hunt awarded me
                 ...
                 <a className="link whitespace-nowrap text-base-content hover:link-accent font-medium group"
                    href="#">6998
                     indie makers</a> are using ShipFast to launch startups quickly, scroll to see what
                they say.</p>
        </div>
        <div className="relative max-sm:-mx-8 mb-16">
            <div
                className="max-lg:hidden absolute top-1/4 -left-4 -translate-x-full text-sm flex flex-col gap-1 items-center">
                <p className="text-base-content/80">The code in 3 minutes</p>
                <svg className="w-12 h-12 fill-base-content/80"
        ...
        <div className="space-y-4 max-w-md mx-auto">
            ...
            <p className="md:text-lg leading-relaxed">It's a game changer. Comes with an easy-to-follow tutorial, and saves
                a ton of time.</p>
            <div className="flex items-center gap-2">
                ...
                />
                {/* <img alt="Yifan testimonial for ShipFast" loading="lazy" width="48"
                    height="48" decoding="async" data-nimg="1" className="w-10 h-10 rounded-full object-cover"
                    style="color:transparent"
                ...
                <p>Yifan Goh</p><span className="badge badge-accent badge-outline">Built an AI tool</span>
            </div>
        </div>
    </div>
</section>
