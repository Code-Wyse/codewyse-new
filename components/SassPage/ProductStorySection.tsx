...
function ProductStorySection() {
  return (
    <section className="bg-white" id="demo">
    <div className="py-24 max-md:px-8 max-w-3xl mx-auto">
        <div className="leading-relaxed text-black/80 mb-12 max-w-xl mx-auto">
        <Image
        alt="image"
        ...
        />
            ...
            <p className="mb-4 text-black md:text-lg font-medium">Hey, it's Marc 👋</p>
            ...
            <ul className="list-inside list-decimal text-black space-y-1.5 ml-5 mb-5">
                <li><span className="text-black font-medium">Save time</span> and focus on what matters:
            ...
            <p className='text-black'><a className="link text-black whitespace-nowrap text-black hover:link-accent font-medium group" target="_blank"
                ...
                Hunt awarded me
                 <a className="link text-black whitespace-nowrap text-black hover:link-accent font-medium group"
                    target="_blank"
                    href="#">Maker of the
                    Year 2023</a>, and
                 <a className="link  whitespace-nowrap text-black hover:link-accent font-medium group"
                    href="#">6998
        ...
        <div className="relative max-sm:-mx-8 mb-16">
            <div
                ...
                <p className="text-black">The code in 3 minutes</p>
        ...
        <div className="space-y-4 max-w-md mx-auto">
            ...
            <p className="md:text-lg text-black leading-relaxed">It's a game changer. Comes with an easy-to-follow tutorial, and saves
                a ton of time.</p>
            <div className="flex items-center gap-2">
                ...
                <p className='text-black'>Yifan Goh</p><span className=" text-black ">Built an AI tool</span>
            </div>
        </div>
    </div>
</section>
