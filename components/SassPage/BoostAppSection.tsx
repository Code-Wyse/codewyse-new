...
const BoostAppSection: React.FC = () => {
    return (
        <section className="bg-[#38a297]">
            <div className="pb-32 pt-16 px-8 max-w-3xl mx-auto flex flex-col items-center gap-8 md:gap-12">
                <div className="text-center">
                    <FontAwesomeIcon
                        icon={faRocket}
                        className="text-white w-8 h-8 md:w-22 md:h-22 rotate-12 ml-auto md:-mr-8"
                    />

                    <h2 className="font-bold text-3xl md:text-5xl text-white tracking-tight mt-4 mb-4 md:mb-8">
...
export default BoostAppSection;
