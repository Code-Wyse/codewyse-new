        ...
        <section
            ...
            <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start"><a
                ...
                <h1
                    ...
                    className="font-extrabold text-4xl lg:text-6xl tracking-tight md:-mb-4 flex flex-col gap-3 items-center text-black lg:items-start">
                ...
                <p className="text-lg text-black leading-relaxed">The NextJS boilerplate with all you need to build your SaaS, AI
                    tool, or any other web app and make your first $ online fast.</p>
                <div className="space-y-4"><button className="btn btn-primary group text-black btn-wide plausible-event-name=Checkout"
                    ...
                    </svg> <span className='text-black'><span className="text-black">$100
