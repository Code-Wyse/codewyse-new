        ...
        <section
            ...
            <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start"><a
                ...
                target="_blank" className=" -mb-4 md:-mb-6 group" title="View ShipFast on Product Hunt"><svg
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122 37"
                ...
                <h1
                    ...
                    className="font-extrabold text-4xl lg:text-6xl tracking-tight md:-mb-4 flex flex-col gap-3 items-center lg:items-start">
                    <span className="relative">Ship your startup </span><span className="whitespace-nowrap relative "><span
                        className="mr-3 sm:mr-4 md:mr-5">in days,</span><span className=" relative whitespace-nowrap"><span
                            className="absolute bg-neutral-content -left-2 -top-1 -bottom-1 -right-2 md:-left-3 md:-top-0 md:-bottom-0 md:-right-3 -rotate-1"></span><span
                                className="relative text-neutral">not weeks</span></span></span></h1>
                <p className="text-lg opacity-80 leading-relaxed">The NextJS boilerplate with all you need to build your SaaS, AI
                    tool, or any other web app and make your first $ online fast.</p>
                <div className="space-y-4"><button className="btn btn-primary group btn-wide plausible-event-name=Checkout"
                    ...
                    <p className="text-sm md:text-base flex justify-center items-center gap-2 md:text-sm"><svg
                        className="w-5 h-5 fill-accent animate-pulse" viewBox="0 0 161 154" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <g style={{ clipPath: 'circle(50%)' }}
                        >
                            <path
                    ...
                    </svg> <span><span className="text-accent">$100
                        off</span> for the first
                            7010
                            customers (
                            12
                            left)</span></p>
                ...
                <div className="flex flex-col md:flex-row justify-center align-center gap-3">
                    <div className="-space-x-5 avatar-group justy-start">
                        <div className="avatar w-12 h-12">
                            <Image
                                ...
                                height={40}
                            />
                            {/* <img alt="Lennard" fetchpriority="high" width="400" height="400"
                            decoding="async" data-nimg="1" style="color:transparent"
                            srcset="/_next/static/media/lennard.a8caddd5.jpeg 1x, /_next/static/media/lennard.a8caddd5.jpeg 2x"
                            src="/_next/static/media/lennard.a8caddd5.jpeg"> */}
                        ...
                        <div className="avatar w-12 h-12">
                            <Image
                                ...
                                height={40}
                            />
                            {/* <img alt="Wahab" fetchpriority="high" width="400" height="400"
                            decoding="async" data-nimg="1" style="color:transparent"
                            srcset="/_next/static/media/wahab.c0419676.jpeg 1x, /_next/static/media/wahab.c0419676.jpeg 2x"
                            src="/_next/static/media/wahab.c0419676.jpeg"> */}
                        ...
                        <div className="avatar w-12 h-12">
                            <Image
                                ...
                                height={40}
                            />
                            {/* <img alt="Naveen" fetchpriority="high" width="400" height="400"
                            decoding="async" data-nimg="1" style="color:transparent"
                        ...
                        <div className="avatar w-12 h-12">
                            <Image
                                ...
                                height={40}
                            />
                            {/* <img alt="Artificery" fetchpriority="high" width="400" height="400"
                            decoding="async" data-nimg="1" style="color:transparent"
                            srcset="/_next/static/media/artificery.ba1049ef.jpeg 1x, /_next/static/media/artificery.ba1049ef.jpeg 2x"
                            src="/_next/static/media/artificery.ba1049ef.jpeg"> */}
                        ...
                        <div className="avatar w-12 h-12">
                            <Image
                                ...
                                height={40}
                            />
                            {/* <img alt="dunsin" fetchpriority="high" width="400" height="400"
                            decoding="async" data-nimg="1" style="color:transparent"
                            srcset="/_next/static/media/dunsin.c7d35d82.jpeg 1x, /_next/static/media/dunsin.c7d35d82.jpeg 2x"
                            src="/_next/static/media/dunsin.c7d35d82.jpeg"> */}
                    ...
                    <div className="flex flex-col justify-center items-center md:items-start gap-1">
                        ...
                        <div className="text-base text-base-content/80"><span className="font-semibold text-base-content">6998</span>
                            maker
                            s
                            ship faster</div>
                    </div>
            ...
            <div className="relative max-md:-m-4 lg:w-full">
                ...
                height="1080" decoding="async" data-nimg="1" className="w-full max-w-xl ml-auto" style="color:transparent"
                srcset="/_next/static/media/demo.753bdb0f.png 1x, /_next/static/media/demo.753bdb0f.png 2x"
                src="/_next/static/media/demo.753bdb0f.png"> */}
